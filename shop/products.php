...
<html>
    ...
    <body>
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    <h1>Welcome to The Hostel Store!</h1>
                    <p>We have everything to make your hostel life smoother. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pencils.jpg" alt="Pencils">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pencils</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Sheet.jpg" alt="Drawing Sheet">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Drawing Sheet</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/buc.jpg" alt="Buckets">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bucket</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/towel.JPG" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Towel</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mat.jpeg" alt="Mattress">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mattress</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/beds.jpg" alt="Bedsheets">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Bedsheets</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/broom.jpg" alt="Broom">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Broom</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/hand.jpg" alt="Handwash">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Handwash</h3>
                        ...
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/maggi.jpg" alt="Maggi">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Maggi</h3>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/paz.jpg" alt="Pazzta">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Pazzta</h3>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/mac.jpg" alt="Macroni">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Macaroni</h3>
                     ...
                     <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/kettle.jpg" alt="Kettle">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Kettle</h3>
